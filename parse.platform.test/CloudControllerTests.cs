...
namespace ParseTest
{
    ...
    public class CloudControllerTests
    {
        ...
        public Task TestEmptyCallFunction()
        {
            ...
            return controller.CallFunctionAsync<string>("someFunction", null, null, CancellationToken.None)
                .ContinueWith(t =>
                {
        ...
        public Task TestCallFunctionWithWrongType()
        {
            ...
            var controller = new ParseCloudCodeController(mockRunner.Object);
            return controller.CallFunctionAsync<int>("someFunction", null, null, CancellationToken.None).ContinueWith(
                t =>
                {
                    Assert.True(t.IsFaulted);
                    Assert.IsFalse(t.IsCanceled);
