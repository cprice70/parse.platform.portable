...
namespace ParseTest
{
  ...
  public class ObjectControllerTests {
    ...
    public Task TestSaveAll() {
      ...
      var controller = new ParseObjectController(mockRunner.Object);
      var tasks = controller.SaveAllAsync(states, operationsList, null, CancellationToken.None).ToList();
    ...
    public Task TestDeleteAllFailSome() {
      ...
      var controller = new ParseObjectController(mockRunner.Object);
      var tasks = controller.DeleteAllAsync(states, null, CancellationToken.None).ToList();
