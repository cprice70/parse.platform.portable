...
namespace ParseTest
{
  ...
  public class CurrentUserControllerTests {
    ...
    public Task TestGetSetAsync() {
      ...
      return controller.SetAsync(user, CancellationToken.None).ContinueWith(_ => {
    ...
    public Task TestIsCurrent() {
      ...
      storageController.Setup(s => s.LoadAsync()).Returns(Task.FromResult(mockedStorage.Object));
            ...
            return controller.SetAsync(user, CancellationToken.None).ContinueWith(t => {
    ...
    public Task TestCurrentSessionToken() {
      ...
      storageController.Setup(c => c.LoadAsync()).Returns(Task.FromResult(mockedStorage.Object));
            ...
            return controller.GetCurrentSessionTokenAsync(CancellationToken.None).ContinueWith(t => {
      ...
      .ContinueWith(_ => controller.GetCurrentSessionTokenAsync(CancellationToken.None)).Unwrap()
                             .ContinueWith(t => {
    ...
    public Task TestLogOut() {
      ...
      }).Unwrap().ContinueWith(_ => controller.GetAsync(CancellationToken.None)).Unwrap()
                       .ContinueWith(t => {
        Assert.IsNull(t.Result);
