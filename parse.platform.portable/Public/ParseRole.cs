...
namespace Parse.Public
{
    ...
    ///  of <see cref="T:Parse.Public.ParseUser" />s for the purposes of granting permissions (e.g.
    ///  specifying a <see cref="T:Parse.Public.ParseAcl" /> for a <see cref="T:Parse.Public.ParseObject" />. Roles
    ...
    public class ParseRole : ParseObject
    {
        ...
        public ParseRelation<ParseUser> Users => GetRelationProperty<ParseUser>(nameof(Users));
        ...
        public ParseRelation<ParseRole> Roles => GetRelationProperty<ParseRole>(nameof(Roles));
