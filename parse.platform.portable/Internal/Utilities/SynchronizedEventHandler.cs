...
namespace Parse.Internal.Utilities
{
    ...
    {
        private readonly LinkedList<Tuple<Delegate, TaskFactory>> _delegates =
        ...
        public void Add(Delegate del)
        {
            lock (_delegates)
            {
                ...
                {
                    _delegates.AddLast(new Tuple<Delegate, TaskFactory>(d, factory));
                }
            }
        }
